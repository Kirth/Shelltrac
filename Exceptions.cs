...
namespace Shelltrac
{
    ...
    public class ShelltracException : Exception
    {
        ...
        public ShelltracException(string message, int line = 0, int column = 0, 
            string scriptFragment = "", Exception? innerException = null)
        ...
        {
            string location = Line > 0 ? $" at line {Line}" + (Column > 0 ? $", column {Column}" : "") : "";
    ...
    {
        public ParsingException(string message, int line = 0, int column = 0, 
            string scriptFragment = "", Exception? innerException = null)
    ...
    {
        public RuntimeException(string message, int line = 0, int column = 0, 
            string scriptFragment = "", Exception? innerException = null)
    ...
    public class ShellCommandException : RuntimeException
    {
        ...
        public ShellCommandException(string message, string command, int? exitCode = null,
            int line = 0, int column = 0, string scriptFragment = "", Exception? innerException = null)
    ...
    public class SshCommandException : ShellCommandException
    {
        ...
        public SshCommandException(string message, string host, string command, int? exitCode = null,
            int line = 0, int column = 0, string scriptFragment = "", Exception? innerException = null)
            : base($"SSH command failed: {message}", command, exitCode, line, column, scriptFragment, innerException)
        {
            Host = host;
        }
